...
static const char *fonts[]          = { "Terminus:size=10:antialias=false:autohint=true" };
static const char dmenufont[]       = "Terminus:size=10:antialias=false:autohint=true";
...
static const char *webcmd[]  = { "brave-browser", NULL };//{ "qutebrowser", NULL };//{ "tabbed", "-c", "surf", "-e", NULL };
static const char *editorcmd[]  = { "tabbed", "-r", "2", "-c", "st", "-w", "-e", "nano", NULL };
...
static Key keys[] = {
	...
	//{ MODKEY,                       XK_j,	 			spawn,          {.v = javaidecmd } },
	//{ MODKEY,                       XK_c,	 			spawn,          {.v = cidecmd } },
